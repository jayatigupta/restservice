...
public abstract class AbstractServiceClient {
    ...
    public AbstractServiceClient(String endPointUrl) {
     ...
     */
    protected <T> T get(String endPointUrl, Class<T> typeClass, Map<String, String> customHeaders)
	    throws RuntimeException {
	try {
    ...
    protected <T> T get(String endPointUrl, Type typeOfT, Map<String, String> customHeaders) throws RuntimeException {
	try {
	    final Map<String, String> headers = buildCustomHeaders(customHeaders);
	    HttpGet get = new HttpGet(endPointUrl);
	    get.addHeader("content-type", APPLICATION_JSON_UTF);
	    ...
	    HttpResponse httpResponse = httpClient.execute(get);
	    handleResponse(httpResponse);
	    String jsondoc = EntityUtils.toString(httpResponse.getEntity());
	    return gson.fromJson(jsondoc, typeOfT);
	} catch (IOException e) {
	    e.getStackTrace();
     ...
     * @throws RuntimeException
     */
    protected <T> T post(String endPointUrl, Object request, Class<T> typeClass, Map<String, String> customHeaders)
	    throws RuntimeException {
	try {
	    final Map<String, String> headers = buildCustomHeaders(customHeaders);
	    ...
	    handleResponse(httpResponse);
	    String jsondoc = EntityUtils.toString(httpResponse.getEntity());
	    return gson.fromJson(jsondoc, typeClass);
	} catch (IOException e) {
     ...
     * 
     */
    protected <T> T put(String endPointUrl, Object request, Class<T> typeClass, Map<String, String> customHeaders) {
	try {
	    final Map<String, String> headers = buildCustomHeaders(customHeaders);
	    String jsonValue = gson.toJson(request);
	    HttpEntity requestEntity = new StringEntity(jsonValue);
     ...
     *            custom header that should be pass along with this request
     */
    protected <T> T delete(String endPointUrl, Class<T> typeClass, Map<String, String> customHeaders) {
	try {
	    final Map<String, String> headers = buildCustomHeaders(customHeaders);
	...
	throw new RuntimeException("Error in response : " + sb.toString() + " status code :" + statusCode);
    }
}